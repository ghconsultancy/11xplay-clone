...
export const metadata: Metadata = {
  ...
  description:
    "Log in or register your 11xPlay account. Access fantasy sports, live casino, and instant UPI withdrawals.",
    ...
    <>
      ...
      <main id="main-content" className="login-page">
        <div className="login-card">
          ...
          <p className="login-subtitle">Sign in to your 11xPlay account</p>
