...
const registerSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Register", item: `${siteUrl}/register` },
  ],
};
    ...
    <>
      ...
      <main id="main-content" className="login-page">
        <div className="login-card">
          ...
          <h1 className="login-title">Create Your Cricket ID</h1>
          <p className="login-subtitle">Register on 11xPlay in minutes — join millions of Indian fantasy sports players.</p>
          ...
          <form action="#" method="POST" noValidate>
            ...
            <div className="form-group">
              <label htmlFor="reg-username" className="form-label">Choose Username</label>
              <input
                id="reg-username"
                name="username"
                type="text"
          ...
          <div className="login-divider">or get instant access via</div>
          ...
          <p style={{ textAlign: "center", fontSize: "11px", color: "var(--color-text-muted)", marginTop: "16px", lineHeight: 1.6 }}>
            By registering you confirm you are 18+ and agree to our{" "}
            <Link href="/terms" style={{ color: "var(--color-gold)" }}>Terms</Link>{" "}
            and{" "}
            <Link href="/responsible-gaming" style={{ color: "var(--color-gold)" }}>Responsible Gaming</Link>{" "}
            policy.
          </p>
        </div>
      </main>
